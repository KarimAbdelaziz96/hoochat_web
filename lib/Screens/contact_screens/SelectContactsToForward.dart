              ...
              return Consumer<SmartContactProviderWithLocalStoreData>(
                  builder: (context, contactsProvider, _child) => Consumer<
                      ...
                      builder: (context, groupList, _child) => Scaffold(
                          ...
                          bottomSheet: selectedDynamicListFORUSERS.length != 0 ||
                          ...
                          body: RefreshIndicator(
                              onRefresh: () {
                                return contactsProvider.syncContactsFromCloud(
                                    context,
                                    widget.currentUserNo!,
                                    widget.prefs);
                              },
                              child:
                                  contactsProvider.searchingcontactsindatabase == true ||
                                          ...
                                          ? SingleChildScrollView(
                                              ...
                                              child: Center(
                                                  child: Container(
                                                      ...
                                                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: noContactsWidget(context)))))
                                          : SingleChildScrollView(
                                              physics: BouncingScrollPhysics(),
                                                            ...
                                                            ListTile(
                                                              trailing:
                                                                ...
                                                                child: selectedDynamicListFORGROUPS.lastIndexWhere((element) =>
                                                                            element[Dbkeys.groupID] ==
                                                                            joinedGroupsList[i][Dbkeys.groupID]) >=
                                                                        0
                                                                    ? Icon(
                                                                        Icons
                                                                            .check,
                                                                ...
                                                                setStateIfMounted(
                                                                  ...
                                                                  if (selectedDynamicListFORGROUPS.lastIndexWhere((element) =>
                                                                    ...
                                                                    if (selectedDynamicListFORUSERS.length +
                                                                      ...
                                                                      selectedDynamicListFORGROUPS.add(
                                                                          joinedGroupsList[
                                                                              i]);
                                                                      setStateIfMounted(
                                                                          () {});
