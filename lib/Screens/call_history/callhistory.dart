...
import 'package:hoochat_web/Screens/call_history/utils/InfiniteListView.dart';
                                    ...
                                    child: Row(
                                      children: <Widget>[
                                        ...
                                        IsShowNativeTimDate == true
                                            ? Text(getTranslated(
                                                    this.context,
                                                    Jiffy.parseFromDateTime(DateTime.fromMillisecondsSinceEpoch(dc["TIME"]))
                                                        .MMMM
                                                        .toString()) +
                                                ' ' +
                                            ...
                                            : Text(Jiffy.parseFromDateTime(DateTime
                                                ...
                                                Jiffy.parseFromDateTime(
                                                        DateTime.fromMillisecondsSinceEpoch(dc["TIME"]))
                                                    .Hm
                                                    .toString()),
                                        // Text(time)
                                      ],
