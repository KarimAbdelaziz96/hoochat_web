...
import 'package:hoochat_web/Utils/batch_write_component.dart';
    ...
    await FirebaseFirestore.instance
      ...
      if (firestoredoc.exists) {
        ...
        await FirebaseFirestore.instance
          ...
          if (onError.toString().contains("permission") ||
              onError.toString().contains("missing") ||
              onError.toString().contains("denied") ||
              onError.toString().contains("permissions") ||
              onError.toString().contains("insufficient")) {
            ...
            showERRORSheet(this.context, "71214",
                message: onError.toString().contains(
                        "Failed to get document because the client is offline.")
                    ? "Could not connect to Server. Please try again !"
                    : onError.toString().contains('XMLHttpRequest')
